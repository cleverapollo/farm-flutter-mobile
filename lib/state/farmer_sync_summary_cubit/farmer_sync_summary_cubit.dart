...
class FarmerSyncSummaryCubit {
  ...
  void initData() {
    data
      ...
      ..add(SyncPairItemModel('Unsynced', count: 0))
      ..add(SyncPairItemModel('Total Workers', count: 0))
      ..add(SyncPairItemModel('Registers', isTitle: true))
      ..add(SyncPairItemModel('Unsynced Accident and Incident', count: 0))
      ...
      ..add(SyncPairItemModel('Total Accident and Incident Property Damaged',
          count: 0))
      ..add(SyncPairItemModel('Unsynced ASI', count: 0))
      ..add(SyncPairItemModel('Total ASI', count: 0))
      ..add(SyncPairItemModel('Unsynced ASI Photos', count: 0))
      ..add(SyncPairItemModel('Total ASI Photos', count: 0))
      ..add(SyncPairItemModel('Unsynced Biological Control Agents', count: 0))
      ..add(SyncPairItemModel('Total Biological Control Agents', count: 0))
      ..add(SyncPairItemModel('Unsynced Chemicals', count: 0))
      ..add(SyncPairItemModel('Total Chemicals', count: 0))
      ..add(SyncPairItemModel('Unsynced Disciplinaries', count: 0))
      ..add(SyncPairItemModel('Total Disciplinaries', count: 0))
      ..add(SyncPairItemModel('Unsynced Stakeholder Complaints', count: 0))
      ..add(SyncPairItemModel('Total Stakeholder Complaint', count: 0))
      ..add(SyncPairItemModel('Employee Grievances', count: 0))
      ..add(SyncPairItemModel('1', count: 0))
      ..add(SyncPairItemModel('Fire', count: 0))
      ..add(SyncPairItemModel('1', count: 0))
      ..add(SyncPairItemModel('Pets and Disease', count: 0))
      ..add(SyncPairItemModel('1', count: 0))
      ..add(SyncPairItemModel('Pets and Disease Treatment Methods', count: 0))
      ..add(SyncPairItemModel('1', count: 0))
      ..add(SyncPairItemModel('RTE Species Registers', count: 0))
      ..add(SyncPairItemModel('1', count: 0))
      ..add(SyncPairItemModel('RTE Species Registers Photos', count: 0))
      ..add(SyncPairItemModel('1', count: 0))
      ..add(SyncPairItemModel('Training', count: 0))
      ..add(SyncPairItemModel('1', count: 0))
      ...
      ..add(SyncPairItemModel('Annual Budget Transactions', isTitle: true))
      ..add(SyncPairItemModel('Unsynced', count: 0))
      ..add(SyncPairItemModel('Total Annual Budgets Productions', count: 0))
