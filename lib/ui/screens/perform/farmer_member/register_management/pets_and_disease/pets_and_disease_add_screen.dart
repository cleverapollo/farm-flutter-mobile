            ...
            children: [
                    ...
                    children: [
                      ...
                      AttributeItem(
                        ...
                        child: InputAttributeItem(
                          initialValue: (state.petsAndDiseaseRegister
                                      ?.numberOfOutbreaks ??
                                  '')
                              .toString(),
                          ...
                          onChanged: (value) {
                            cubit.onChangeData(
                                numberOfOutbreaks: int.parse(value));
                          },
                        ),
                      ),
                      AttributeItem(
                          ...
                          onTap: () async {
                            ...
                            final result = await SelectPropertyDamaged.push(
                              ...
                              selectTreatmentMethod:
                                  state.selectedTreatmentMethods,
                            );

                            if (result != null) {
                              cubit.onSelectTreatmentMethod(
                                  result as List<TreatmentMethod>);
                            }
                          },
                          child: Row(
                            children: [
                              Expanded(
                                child: Padding(
                                  ...
                                  child: Text(
                                    ...
                                    style:
                                        context.textStyles.bodyNormal.blueDark3,
                                    maxLines: 1,
                      ...
                      AttributeItem(
                        ...
                        child: SelectorAttributeItem(
                          ...
                          trailing: SizedBox(
                            ...
                            child: Switch(
                              value:
                                  state.petsAndDiseaseRegister?.underControl ??
                                      false,
              ...
              Padding(
                ...
                child: CmoFilledButton(
                  ...
                  onTap: () async {
                    final canNext = await context
                        .read<PetsAndDiseasesDetailCubit>()
                        .onSave();
