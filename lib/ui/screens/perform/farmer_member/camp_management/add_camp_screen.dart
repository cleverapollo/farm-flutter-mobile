                      ...
                      child: Column(
                        children: [
                          ...
                          AttributeItem(
                            child: InputAttributeItem(
                              initialValue:
                                  cubit.state.camp?.protectedArea?.toString(),
                              maxLines: 2,
                              keyboardType: TextInputType.number,
                              hintText: LocaleKeys.hectares_camp_protected.tr(),
                              onChanged: (value) =>
                                  cubit.onProtectedAreaChanged(value),
                              validator: requiredValidator,
                            ),
                          ),
                          AttributeItem(
                            child: InputAttributeItem(
                              ...
                              keyboardType: TextInputType.number,
                              hintText: LocaleKeys
                                  .hectares_camp_cattle_posts_housing
                                  .tr(),
                              onChanged: (value) =>
                                  cubit.onCattlePostHousingChanged(value),
                              validator: requiredValidator,
                            ),
                          ),
                          AttributeItem(
                            child: InputAttributeItem(
                              initialValue:
                                  cubit.state.camp?.corridors?.toString(),
                              maxLines: 2,
                              keyboardType: TextInputType.number,
                              hintText: LocaleKeys.hectares_are_corridors.tr(),
                              onChanged: (value) =>
                                  cubit.onCorridorsChanged(value),
                              validator: requiredValidator,
                            ),
                          ),
                          AttributeItem(
                            child: InputAttributeItem(
                              initialValue: cubit.state.camp?.roadAndFireBreaks
                                  ?.toString(),
                              maxLines: 2,
                              keyboardType: TextInputType.number,
                              hintText:
                                  LocaleKeys.hectares_road_fire_breaks.tr(),
                              onChanged: (value) =>
                                  cubit.onRoadAndFireBreaksChanged(value),
                              validator: requiredValidator,
                            ),
                          ),
                          AttributeItem(
                            child: InputAttributeItem(
                              initialValue: cubit
                                  .state.camp?.poachingAlleviationZone
                                  ?.toString(),
                              maxLines: 2,
                              keyboardType: TextInputType.number,
                              hintText: LocaleKeys
                                  .hectares_poaching_alleviation_zones
                                  .tr(),
                              onChanged: (value) =>
                                  cubit.onPoachingAlleviationZoneChanged(value),
                              validator: requiredValidator,
                            ),
                          ),
                          GestureDetector(
                            ...
                            child: AttributeItem(
                              child: SelectorAttributeItem(
                                ...
                                text: cubit.state.camp?.latitude == null
                                    ? null
