                                  ...
                                  child: CmoTappable(
                                    ...
                                    child: CmoCard(
                                      content: [
                                        ...
                                        CmoCardItem(
                                          title: LocaleKeys.asi_no.tr(),
                                          value: listAsi[index].asiRegisterNo ?? '',
                                        ),
                                        CmoCardItem(
                                          title: LocaleKeys.compartment.tr(),
                                          value: listAsi[index].compartmentName ?? '',
                                        ),
                                        CmoCardItem(
                                          title: LocaleKeys.asiType.tr(),
                                          value: listAsi[index].asiTypeName ?? '',
                                        ),
                                      ],
                                    ),
                                  ),
