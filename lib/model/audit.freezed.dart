...
class _$_Audit extends _Audit {
  ...
  @override
  String toString() {
    return 'Audit(auditId: $auditId, auditTemplateName: $auditTemplateName, auditTemplateId: $auditTemplateId, compartmentName: $compartmentName, compartmentId: $compartmentId, siteName: $siteName, siteId: $siteId, completed: $completed, createDT: $createDT, updateDT: $updateDT, status: $status, isActive: $isActive, isLocal: $isLocal)';
  }
...
abstract class _Audit extends Audit {
  const factory _Audit(
      ...
      @JsonKey(name: 'AuditTemplateId') final int? auditTemplateId,
