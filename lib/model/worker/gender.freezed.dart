...
class _$_Gender extends _Gender {
  ...
  @override
  String toString() {
    return 'Gender(genderId: $genderId, genderName: $genderName, isActive: $isActive)';
  }
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, genderId, genderName, isActive);
...
abstract class _Gender extends Gender {
  const factory _Gender(
      ...
      @JsonKey(name: 'IsActive') final bool? isActive}) = _$_Gender;
