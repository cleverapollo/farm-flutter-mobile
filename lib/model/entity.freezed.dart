...
abstract class $EntityCopyWith<$Res> {
  ...
  @useResult
  $Res call({String name, EntityType type});
}
...
class _$_Entity implements _Entity {
  const _$_Entity({required this.name, required this.type});
...
abstract class _Entity implements Entity {
  const factory _Entity(
      {required final String name, required final EntityType type}) = _$_Entity;
