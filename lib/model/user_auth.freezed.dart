...
mixin _$UserAuth {
  ...
  String? get renewalToken => throw _privateConstructorUsedError;
    ...
    return _then(_value.copyWith(
      ...
      accessToken: freezed == accessToken
          ...
          : accessToken // ignore: cast_nullable_to_non_nullable
              as String?,
      renewalToken: freezed == renewalToken
          ? _value.renewalToken
          : renewalToken // ignore: cast_nullable_to_non_nullable
              as String?,
    ) as $Val);
  }
}
...
class _$_UserAuth implements _UserAuth {
  const _$_UserAuth(
      {this.userId, this.displayName, this.accessToken, this.renewalToken});
  ...
  @override
  String toString() {
    return 'UserAuth(userId: $userId, displayName: $displayName, accessToken: $accessToken, renewalToken: $renewalToken)';
  }
  ...
  bool operator ==(dynamic other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            (identical(other.renewalToken, renewalToken) ||
                other.renewalToken == renewalToken));
  }

  @JsonKey(ignore: true)
  @override
  int get hashCode =>
      Object.hash(runtimeType, userId, displayName, accessToken, renewalToken);
...
abstract class _UserAuth implements UserAuth {
  const factory _UserAuth(
      ...
      final String? displayName,
      final String? accessToken,
      final String? renewalToken}) = _$_UserAuth;
