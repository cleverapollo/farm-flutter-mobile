...
extension AnnualFarmProductionX on AnnualFarmProduction {
  AnnualFarmProductionPayload toPayLoad() {
    return AnnualFarmProductionPayload(
      ...
      AnnualCharcoalProductionPerPerson: annualCharcoalProductionPerPerson,
      AnnualCharcoalProductionPerTeam: annualCharcoalProductionPerTeam,
      ConversionWoodToCharcoal: conversionWoodToCharcoal,
      AnnualWoodBiomassRemoved: annualWoodBiomassRemoved,
