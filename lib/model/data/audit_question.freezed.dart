...
AuditQuestion _$AuditQuestionFromJson(Map<String, dynamic> json) {
  return _AuditQuestion.fromJson(json);
}

/// @nodoc
mixin _$AuditQuestion {
  ...
  @JsonKey(ignore: true)
  $AuditQuestionCopyWith<AuditQuestion> get copyWith =>
      throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $AuditQuestionCopyWith<$Res> {
  factory $AuditQuestionCopyWith(
          AuditQuestion value, $Res Function(AuditQuestion) then) =
      _$AuditQuestionCopyWithImpl<$Res, AuditQuestion>;
  @useResult
  $Res call(
...
/// @nodoc
class _$AuditQuestionCopyWithImpl<$Res, $Val extends AuditQuestion>
    implements $AuditQuestionCopyWith<$Res> {
  _$AuditQuestionCopyWithImpl(this._value, this._then);
    ...
    return _then(_value.copyWith(
      ...
      questionValue: freezed == questionValue
          ...
          : questionValue // ignore: cast_nullable_to_non_nullable
              as String?,
      principleId: freezed == principleId
          ? _value.principleId
...
/// @nodoc
abstract class _$$_AuditQuestionCopyWith<$Res>
    implements $AuditQuestionCopyWith<$Res> {
  factory _$$_AuditQuestionCopyWith(
          _$_AuditQuestion value, $Res Function(_$_AuditQuestion) then) =
      __$$_AuditQuestionCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call(
      {@JsonKey(name: 'AuditId') int auditId,
...
/// @nodoc
class __$$_AuditQuestionCopyWithImpl<$Res>
    extends _$AuditQuestionCopyWithImpl<$Res, _$_AuditQuestion>
    implements _$$_AuditQuestionCopyWith<$Res> {
  __$$_AuditQuestionCopyWithImpl(
      _$_AuditQuestion _value, $Res Function(_$_AuditQuestion) _then)
      : super(_value, _then);
...
/// @nodoc
@JsonSerializable()
class _$_AuditQuestion extends _AuditQuestion {
  const _$_AuditQuestion(
      ...
      @JsonKey(name: 'PrincipleId') this.principleId,
      @JsonKey(name: 'PrincipleName') this.principleName,
      @JsonKey(name: 'IndicatorId') this.indicatorId,
  ...
  factory _$_AuditQuestion.fromJson(Map<String, dynamic> json) =>
      _$$_AuditQuestionFromJson(json);
  ...
  @override
  String toString() {
    return 'AuditQuestion(auditId: $auditId, questionId: $questionId, questionValue: $questionValue, principleId: $principleId, principleName: $principleName, indicatorId: $indicatorId, indicatorName: $indicatorName, carId: $carId, carName: $carName, criteriaId: $criteriaId, criteriaName: $criteriaName, jobCategoryId: $jobCategoryId, jobCategoryName: $jobCategoryName, impactOnId: $impactOnId, impactOnName: $impactOnName, impactCausedId: $impactCausedId, impactCausedName: $impactCausedName, severityId: $severityId, xBone: $xBone, mmmId: $mmmId, mmmName: $mmmName, complianceName: $complianceName, complianceId: $complianceId, isQuestionComplete: $isQuestionComplete, isActive: $isActive)';
  }
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$_AuditQuestionCopyWith<_$_AuditQuestion> get copyWith =>
      __$$_AuditQuestionCopyWithImpl<_$_AuditQuestion>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$_AuditQuestionToJson(
      this,
    );
  }
}

abstract class _AuditQuestion extends AuditQuestion {
  const factory _AuditQuestion(
      ...
      @JsonKey(name: 'PrincipleId') final int? principleId,
      @JsonKey(name: 'PrincipleName') final String? principleName,
      @JsonKey(name: 'IndicatorId') final int? indicatorId,
      ...
      @JsonKey(name: 'IsActive') final bool? isActive}) = _$_AuditQuestion;
  const _AuditQuestion._() : super._();

  factory _AuditQuestion.fromJson(Map<String, dynamic> json) =
      _$_AuditQuestion.fromJson;
