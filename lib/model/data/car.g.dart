...
void _carSerialize(
  ...
  writer.writeString(offsets[1], object.carName);
...
Car _carDeserialize(
  ...
  final object = Car(
    ...
    carName: reader.readStringOrNull(offsets[1]),
...
extension CarQueryFilter on QueryBuilder<Car, Car, QFilterCondition> {
  ...
  QueryBuilder<Car, Car, QAfterFilterCondition> carNameIsNull() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Car, Car, QAfterFilterCondition> carNameIsNotNull() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Car, Car, QAfterFilterCondition> carNameEqualTo(
    String? value, {
  ...
  QueryBuilder<Car, Car, QAfterFilterCondition> carNameGreaterThan(
    String? value, {
    bool include = false,
    bool caseSensitive = true,
  }) {
  ...
  QueryBuilder<Car, Car, QAfterFilterCondition> carNameLessThan(
    String? value, {
    bool include = false,
    bool caseSensitive = true,
  }) {
  ...
  QueryBuilder<Car, Car, QAfterFilterCondition> carNameBetween(
    String? lower,
    String? upper, {
    bool includeLower = true,
    bool includeUpper = true,
  ...
  QueryBuilder<Car, Car, QAfterFilterCondition> carNameStartsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Car, Car, QAfterFilterCondition> carNameEndsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Car, Car, QAfterFilterCondition> carNameContains(String value,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Car, Car, QAfterFilterCondition> carNameMatches(String pattern,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Car, Car, QAfterFilterCondition> carNameIsEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'carName',
        value: '',
  ...
  QueryBuilder<Car, Car, QAfterFilterCondition> carNameIsNotEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.greaterThan(
        property: r'carName',
        value: '',
  ...
  QueryBuilder<Car, Car, QAfterFilterCondition> isActiveIsNull() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(const FilterCondition.isNull(
        property: r'isActive',
      ));
  ...
  QueryBuilder<Car, Car, QAfterFilterCondition> isActiveIsNotNull() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(const FilterCondition.isNotNull(
        property: r'isActive',
      ));
...
extension CarQuerySortBy on QueryBuilder<Car, Car, QSortBy> {
  ...
  QueryBuilder<Car, Car, QAfterSortBy> sortByCarName() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'carName', Sort.asc);
    });
  }

  QueryBuilder<Car, Car, QAfterSortBy> sortByCarNameDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension CarQuerySortThenBy on QueryBuilder<Car, Car, QSortThenBy> {
  ...
  QueryBuilder<Car, Car, QAfterSortBy> thenByCarName() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'carName', Sort.asc);
    });
  }

  QueryBuilder<Car, Car, QAfterSortBy> thenByCarNameDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'carName', Sort.desc);
    });
  }
...
extension CarQueryWhereDistinct on QueryBuilder<Car, Car, QDistinct> {
  ...
  QueryBuilder<Car, Car, QDistinct> distinctByCarName(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
...
extension CarQueryProperty on QueryBuilder<Car, Car, QQueryProperty> {
  ...
  QueryBuilder<Car, String?, QQueryOperations> carNameProperty() {
    return QueryBuilder.apply(this, (query) {
